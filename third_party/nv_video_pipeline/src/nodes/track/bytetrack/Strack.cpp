#include "track/bytetrack/Strack.hpp"

#include <vector>

namespace ByteTrack {
STrack::STrack(vector<float> tlwh_, float score, object_meta::FrameTarget::ptr frame_target) {
    _tlwh.resize(4);
...
void STrack::re_activate(STrack &new_track, int frame_id, bool new_id) {
    ...
    this->frame_target = new_track.frame_target;
